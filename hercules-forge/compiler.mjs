...
let active=entities[0]||null; let editing=null;
...
function renderNav(){nav.innerHTML="";for(const entity of entities){const b=document.createElement("button");b.textContent=entity.name;b.onclick=()=>{active=entity;editing=null;render()};nav.appendChild(b)}}
